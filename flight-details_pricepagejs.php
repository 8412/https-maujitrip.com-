...
$total_paxwisefare_ob =  0;
      ...
      $meal_price_ob =  $mealpriceonward;
	  $baggage_price_ob =  $baggaegepriceonward;
	  		if($responce_ib){
						 
						  
     $meal_price_ib =  $mealpricereturn;
	  $baggage_price_ib =  $baggaegepricereturn;
...
?>
    ...
    font-weight: 500; font-size: 13px;"> Promo Discount  <a href="javascript:void(0);" class="remove_promocode">Remove </a>
										</td>
